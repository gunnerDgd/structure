...
__synapse_structure_slist_node* 
	__synapse_structure_slist_insert_at   
		(__synapse_structure_slist_head*, void*, size_t, size_t);
...
void							
	__synapse_structure_slist_erase_front 
		(__synapse_structure_slist_head*);
void							
	__synapse_structure_slist_erase_at    
		(__synapse_structure_slist_head*, size_t);
