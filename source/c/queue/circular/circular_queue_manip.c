...
synapse_structure_circular_queue_read_from
	(synapse_structure_circular_queue pQueue, void* pData, size_t pDataSize)
{
...
synapse_structure_circular_queue_read_pointer
	(synapse_structure_circular_queue pQueue)
{
...
synapse_structure_circular_queue_node
synapse_structure_circular_queue_write_pointer
	(synapse_structure_circular_queue pQueue)
{
